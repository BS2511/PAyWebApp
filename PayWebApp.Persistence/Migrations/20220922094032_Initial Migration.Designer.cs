...
namespace PayWebApp.Persistence.Migrations
{
    ...
    [Migration("20220922094032_Initial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayWebApp.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayWebApp.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayWebApp.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayWebApp.Entity.PaymentRecord", b =>
                {
                    b.HasOne("PayWebApp.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayWebApp.Entity.TaxYear", "TaxYear")
                        .WithMany()
